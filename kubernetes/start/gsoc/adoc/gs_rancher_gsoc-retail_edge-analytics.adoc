...
// document
// -
:title: Edge Analytics in Retail
:subtitle: Retail Store Use Cases
...
:usecase: edge analytics in retail

:executive_summary: This document provides an introduction to the analytics edge ecosystem with Rancher by SUSE through the deployment of machine learning workloads for a retail store. This project is part of the Google Summer of Code, a global online mentoring program focused on introducing new contributors to open source software development.
...
:author1_jobtitle: Google Summer of Code 2023 Contributor
